    ...
    <div className="min-h-screen bg-paper flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-sm bg-surface rounded-2xl border border-rule shadow-md p-8">
        {sent ? (
          <div className="flex flex-col items-center text-center gap-4 py-2">
            ...
            <div>
              ...
              <p className="text-sm text-ink-mute leading-relaxed">
                We sent a reset link to <span className="text-ink font-medium">{email}</span>. It expires in 30 minutes.
              </p>
            </div>
          ...
          <>
            <h1 className="font-display text-2xl font-medium text-ink mb-1">Reset your password</h1>
            <p className="text-sm text-ink-mute mb-7">
